 ...
 * @author Acer
 */
public class HandleUnexpectedSituationController implements Initializable {
    ...
    private void nextButtonOnClick(MouseEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("HandleSituation2.fxml"));
